...
class checkout(View):
    def get(self,request):
        ...
        #{'id': 'order_Ms4l9x9tqx6Qhm', 'entity': 'order', 'amount': 53000, 'amount_paid': 0, 'amount_due': 53000, 'currency': 'INR', 'receipt': 'order_rcptid_12', 'offer_id': None, 'status': 'created', 'attempts': 0, 'notes': [], 'created_at': 1698157434}
